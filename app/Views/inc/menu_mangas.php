<!-- ============================================================== -->
    ...
    <div class="dashboard-header">
        ...
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            ...
            <a class="navbar-brand" href="<?php echo URLROOT; ?>/pages/index">Geekword</a>
            ...
            <div class="menu-list">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                        ...
                        <ul class="navbar-nav flex-column p-t-60">
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo URLROOT; ?>/users/article/<?= $_SESSION['user_id'] ?>">Article</a>
                                <a class="nav-link" href="<?php echo URLROOT; ?>/users/index/<?= $_SESSION['user_id'] ?>">Mangas</a>
                            </li>
                        </ul>
